    ...
    return(
        <section className={TextAndPhotoStyle.TextAndPhoto}>
            <Container className={TextAndPhotoStyle.Container}>
                ...
                <div data-aos="zoom-in" data-aos-delay="1200" className={TextAndPhotoStyle.DescriptionContainer}>
                ...
                <div data-aos="zoom-in" data-aos-delay="1200"className={TextAndPhotoStyle.IconContainer}>
